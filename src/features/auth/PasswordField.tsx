  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        <button type="button" className="absolute right-0.5 top-0.5 grid size-11 place-items-center rounded-lg text-[#65766b] hover:bg-[#eef7f0]" aria-label={visible ? 'Ocultar senha' : 'Mostrar senha'} onClick={() => setVisible((current) => !current)}>
